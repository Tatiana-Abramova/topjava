...
class ProfileRestControllerTest extends AbstractControllerTest {
    ...
    void registerValidationError() throws Exception {
        ...
        ERROR_MATCHER.assertMatch(actualError, createUserErrorInfo);
    }
    ...
    void registerDuplicateEmail() throws Exception {
        ...
        ERROR_MATCHER.assertMatch(actualError, duplicateEmailCreateUserErrorInfo);
    }
    ...
    void updateValidationError() throws Exception {
        ...
        ERROR_MATCHER.assertMatch(actualError, updateUserErrorInfo);
    }
    ...
    void updateDuplicateEmail() throws Exception {
        ...
        ERROR_MATCHER.assertMatch(actualError, duplicateEmailUpdateUserErrorInfo);
    }
