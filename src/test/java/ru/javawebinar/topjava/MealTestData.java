...
public class MealTestData {
    ...
    /*Если создавать матчер через usingEqualsComparator(), то тесты с коллекциями
     * (типа getAll()) падают. Вижу, что у actual не переопределен equals (это ImmutableCollections$ListN)*/
